defmodule TijaraTides.Domain.Guarantees do
  ...
  alias TijaraTides.Domain.{Finance, Journal, Notices}
    ...
    cond do
      ...
      true ->
        ...
        state =
          ...
          |> Journal.post(company["id"], "guarantee_pledge", [
  ...
  defp close(state, g, loss) do
    ...
    |> put("companies", company["id"], %{
      company
      | "cash" => company["cash"] + refund,
        "profit" => company["profit"] - loss
    })
    |> Journal.post(company["id"], "guarantee_settlement", [
