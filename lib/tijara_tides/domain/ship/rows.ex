defmodule TijaraTides.Domain.Ship.Rows do
  ...
  @optional ~w(planned_destination voyage_path paid_canals voyage_speedup berth_queued_ms berth_granted_ms berth_retry_ms pending_side pending_good pending_quantity pending_limit pending_destination cargo)a
