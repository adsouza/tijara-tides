...
5. Regenerate. Coverage minimums are enforced below: bulk commodities need five
...
"Houston": ("Bayport",
 ...
 "recovered-plastics export. Channel draft excludes the largest ships.",
